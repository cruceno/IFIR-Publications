...
class IfirSciViewPublications extends JViewLegacy
{
  ...
  protected function addToolbar()
  {
    		...
    		JToolbarHelper::custom('publications.import','upload.png','upload.png',JText::_('COM_IFIRSCI_IMPORT_PUBLiCATIONS'),false,true);
    		JToolbarHelper::custom('publications.export','download.png','download.png',JText::_('COM_IFIRSCI_EXPORT_PUBLiCATIONS'),false,true);
   
    		if ($canDo->get('core.admin'))
    		{
      			JToolbarHelper::preferences('com_ifirsci','500');
    		}
